...
public:
    ...
    returnValue hotstart(
        ...
        const real_t* const ub_new, /**< Upper bounds of neighbouring QP to be solved. \n
													 			 	 If no upper bounds exist, a NULL pointer can be passed. */
        const real_t* const
            lbA_new, /**< Lower constraints' bounds of neighbouring QP to be solved. \n
													 			 	 If no lower constraints' bounds exist, a NULL pointer can be passed. */
        const real_t* const
            ubA_new, /**< Upper constraints' bounds of neighbouring QP to be solved. \n
    ...
    /** Returns constraint matrix of the QP (deep copy).
		  *	\return SUCCESSFUL_RETURN */
    inline returnValue
    getA(real_t* const _A /**< Array of appropriate dimension for copying constraint matrix.*/
    ) const;

    /** Returns a single row of constraint matrix of the QP (deep copy).
		  *	\return SUCCESSFUL_RETURN \n
					RET_INDEX_OUT_OF_BOUNDS */
    inline returnValue getA(
    ...
    /** Returns current constraints object of the QP (deep copy).
		  *	\return SUCCESSFUL_RETURN */
    inline returnValue
    getConstraints(Constraints* const _constraints /** Output: Constraints object. */
    ) const;
...
protected:
    ...
    returnValue setupAuxiliaryWorkingSet(
        const Bounds* const auxiliaryBounds, /**< Working set of bounds for auxiliary QP. */
        const Constraints* const
    ...
    /** Checks if new active constraint to be added is linearly dependent from
		 ...
		 *	\return	 RET_LINEARLY_DEPENDENT \n
					 ...
					 RET_INDEXLIST_CORRUPTED */
    returnValue
    addConstraint_checkLI(int number /**< Number of constraint to be added to active set. */
    );
    ...
    /** Sets constraint matrix of the QP. \n
		 ...
		 *	\return SUCCESSFUL_RETURN */
    inline returnValue
    setA(const real_t* const A_new /**< New constraint matrix (with correct dimension!). */
    );
    ...
    /** Changes single row of constraint matrix of the QP. \n
		 ...
		 *	\return SUCCESSFUL_RETURN  \n
					RET_INDEX_OUT_OF_BOUNDS */
    inline returnValue setA(
        int number, /**< Number of row to be changed. */
...
protected:
    ...
    CyclingManager
        cyclingManager; /**< Data structure for storing (possible) cycling information (NOT YET IMPLEMENTED!). */
};
