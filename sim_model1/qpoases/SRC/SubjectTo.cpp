 ...
 *	S u b j e c t T o
 */
SubjectTo::SubjectTo(): noLower(BT_TRUE), noUpper(BT_TRUE), size(0) {
    int i;
 ...
 */
returnValue
SubjectTo::addIndex(Indexlist* const indexlist, int newnumber, SubjectToStatus newstatus) {
    /* consistency check */
 ...
 */
returnValue SubjectTo::removeIndex(Indexlist* const indexlist, int removenumber) {
 ...
 *	s w a p I n d e x
 */
returnValue SubjectTo::swapIndex(Indexlist* const indexlist, int number1, int number2) {
    /* consistency checks */
