...
public:
    ...
    MessageHandling(
        myFILE* _outputFile, /**< Output file. */
        VisibilityStatus _errorVisibility, /**< Visibility status for error messages. */
        VisibilityStatus _warningVisibility, /**< Visibility status for warning messages. */
        VisibilityStatus _infoVisibility /**< Visibility status for info messages. */
    );
    ...
    returnValue throwError(
        ...
        VisibilityStatus
            localVisibilityStatus /**< Determines (locally) if error message can be printed to myStderr.
    ...
    returnValue throwWarning(
        ...
        VisibilityStatus
            localVisibilityStatus /**< Determines (locally) if warning message can be printed to myStderr.
		   		  									 *   If GLOBAL visibility status of the message is set to VS_HIDDEN,
					 								 *   no message is printed, anyway! */
    );
    ...
    returnValue throwInfo(
        ...
        VisibilityStatus
            localVisibilityStatus /**< Determines (locally) if info message can be printed to myStderr.
				  									 *   If GLOBAL visibility status of the message is set to VS_HIDDEN,
				   									 *   no message is printed, anyway! */
    );
    ...
    inline void setInfoVisibilityStatus(
