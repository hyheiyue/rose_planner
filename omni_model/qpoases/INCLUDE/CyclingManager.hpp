...
public:
    ...
    returnValue init(
        int _nV, /**< Number of bounds to be managed. */
    ...
    returnValue setCyclingStatus(
        int number, /**< Number of bound/constraint. */
    ...
    /** Returns if bound/constraint might cause cycling.
		 *	\return BT_TRUE: bound/constraint might cause cycling \n
		 			BT_FALSE: otherwise */
    CyclingStatus getCyclingStatus(
        int number, /**< Number of bound/constraint. */
...
protected:
    ...
    CyclingStatus
        status[NVMAX + NCMAX]; /**< Array to store cycling status of all bounds/constraints. */
